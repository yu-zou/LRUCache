...
entity PLRUCache_mux_83_512_2_1 is
generic (
    ID            :integer := 0;
    NUM_STAGE     :integer := 1;
...
architecture rtl of PLRUCache_mux_83_512_2_1 is
    ...
    -- level 2 signals
    signal mux_2_0_reg    : std_logic_vector(511 downto 0);
    signal mux_2_1_reg    : std_logic_vector(511 downto 0);
